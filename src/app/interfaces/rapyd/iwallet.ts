...
import { ewallet_id, WalletTransactionTypes } from './types';
...
export namespace ICreateChckoutPage {
    export interface Request {
        ...
        ewallet:ewallet_id
        fixed_side:"sell" | "buy" // whether the FX rate is fixed for the buy side (seller) or for the sell side (buyer).
        requested_currency:string // recived by the merchant currency
    }
